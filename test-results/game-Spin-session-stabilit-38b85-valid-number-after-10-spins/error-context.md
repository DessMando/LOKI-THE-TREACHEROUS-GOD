...
- Name: game.spec.ts >> Spin session stability >> balance remains a valid number after 10 spins
- Location: e2e\game.spec.ts:178:5
...
Call log:
  ...
  - waiting for locator('#spinBtn')
    10 × locator resolved to <button disabled id="spinBtn" class="btn btn-lg shadow-lg px-5 py-3 fw-bold border-3 border-white btn-secondary">↵      SPIN↵    </button>
