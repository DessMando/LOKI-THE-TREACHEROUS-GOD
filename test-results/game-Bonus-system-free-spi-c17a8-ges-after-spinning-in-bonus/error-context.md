...
- Location: e2e\game.spec.ts:167:5
...
- generic [active] [ref=e1]:
  - banner [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e7]:
        - text: FREE SPINS
        - generic [ref=e8]: 🎁 10 FREE SPINS
      - generic [ref=e9]: 🔥 BONUS ACTIVE
    - generic [ref=e10]:
      - button "TURBO OFF" [ref=e11] [cursor=pointer]
      - button "AUTO PLAY" [ref=e12] [cursor=pointer]
  - contentinfo [ref=e13]:
    - generic [ref=e14]:
      - button "-" [ref=e15] [cursor=pointer]
      - generic [ref=e16]:
        - generic [ref=e17]: BET AMOUNT
        - text: €0.10
      - button "+" [ref=e18] [cursor=pointer]
    - button "SPIN" [ref=e20] [cursor=pointer]
    - button "BUY BONUS" [ref=e22] [cursor=pointer]
```
